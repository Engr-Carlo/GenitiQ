...
export const PERMISSIONS = {
  ...
  TRIGGER_SHUTDOWN: [UserRole.INSPECTOR, UserRole.ADMIN],
  MACHINE_CHECKOUT: [UserRole.OPERATOR],
  VIEW_ALL_MACHINES: [UserRole.INSPECTOR, UserRole.ADMIN],
  REPORT_MACHINE_ISSUE: [UserRole.OPERATOR, UserRole.INSPECTOR],

  // Queue
  VIEW_QUEUE: [UserRole.INSPECTOR, UserRole.OPERATOR, UserRole.ADMIN],
  REGENERATE_QUEUE: [UserRole.ADMIN, UserRole.INSPECTOR],
  SCAN_BARCODE: [UserRole.OPERATOR, UserRole.INSPECTOR],
  START_QUEUE_ITEM: [UserRole.OPERATOR],
  COMPLETE_QUEUE_ITEM: [UserRole.OPERATOR],

  // Analytics
  VIEW_QUALITY_ANALYTICS: [UserRole.INSPECTOR, UserRole.ADMIN],
  VIEW_TIMING_ANALYTICS: [UserRole.INSPECTOR, UserRole.ADMIN],
  VIEW_PERSONAL_METRICS: [UserRole.INSPECTOR, UserRole.OPERATOR],

  // QA Review (second-stage)
  REVIEW_INSPECTION: [UserRole.INSPECTOR],
